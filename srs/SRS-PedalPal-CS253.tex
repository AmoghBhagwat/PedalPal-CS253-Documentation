...
\newcommand{\colorsectionx}[1]{\colorbox{gray!120}{\parbox{\dimexpr\textwidth-2\fboxsep}{\color{white} \centering \huge{Contents}}}}
...
\newcommand{\colorsection}[1]{\colorbox{gray!120}{\parbox{\dimexpr\textwidth-2\fboxsep}{\color{white}\huge{\thesection. }\ #1}}}
...
\newpage
\section{\centering{Overall Description}}
...
\newpage
\section{\centering{Specific Requirements}}
...
\newpage
\section{\centering{Other Non-Functional Requirements}}
...
\newpage
\section{\centering{Other Requirements}}
...
\begin{appendices}
\newpage
\section{\centering{Data Dictionary}}
